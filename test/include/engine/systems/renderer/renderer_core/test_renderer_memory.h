/**
 * @file test_renderer_memory.h
 * @author chocolate-pie24
 * @brief renderer_memoryモジュール用テストAPI定義
 *
 * @version 0.1
 * @date 2026-04-03
 *
 ...
 *
 */
#ifndef GLCE_TEST_ENGINE_SYSTEMS_RENDERER_RENDERER_CORE_TEST_RENDERER_MEMORY_H
#define GLCE_TEST_ENGINE_SYSTEMS_RENDERER_RENDERER_CORE_TEST_RENDERER_MEMORY_H
 ...
 *
 */
void test_renderer_memory_config_reset(void);

/**
 * @brief renderer_memory保有APIのテストを行う
 *
 */
