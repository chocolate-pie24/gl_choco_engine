...
static test_call_control_t s_test_config_choco_string_key_value_key_get;        /**< choco_string_key_value_key_get()テスト設定 */
...
static void test_choco_string_key_value_key_get(void);
...
#ifdef TEST_BUILD
    s_test_config_choco_string_substring_exists.call_count++;
    if(s_test_config_choco_string_substring_exists.fail_on_call != 0) {
        if(s_test_config_choco_string_substring_exists.call_count == s_test_config_choco_string_substring_exists.fail_on_call) {
            return s_test_config_choco_string_substring_exists.forced_result;
        }
    }
#endif
...
choco_string_result_t choco_string_key_value_key_get(const char* line_, choco_string_t* out_key_) {
#ifdef TEST_BUILD
    s_test_config_choco_string_key_value_key_get.call_count++;
    if(s_test_config_choco_string_key_value_key_get.fail_on_call != 0) {
        if(s_test_config_choco_string_key_value_key_get.call_count == s_test_config_choco_string_key_value_key_get.fail_on_call) {
            return (choco_string_result_t)s_test_config_choco_string_key_value_key_get.forced_result;
        }
    }
#endif
    choco_string_result_t ret = CHOCO_STRING_INVALID_ARGUMENT;
    ...
    IF_ARG_FALSE_GOTO_CLEANUP(is_string_valid(out_key_), ret, CHOCO_STRING_DATA_CORRUPTED, rslt_to_str(CHOCO_STRING_DATA_CORRUPTED), "choco_string_key_value_key_get", "out_key_")
...
void test_choco_string_substring_exists_config_set(const test_call_control_bool_t* config_) {
    s_test_config_choco_string_substring_exists.fail_on_call = config_->fail_on_call;
    s_test_config_choco_string_substring_exists.forced_result = config_->forced_result;
}

void test_choco_string_key_value_key_get_config_set(const test_call_control_t* config_) {
    s_test_config_choco_string_key_value_key_get.fail_on_call = config_->fail_on_call;
    s_test_config_choco_string_key_value_key_get.forced_result = config_->forced_result;
}
...
void test_choco_string_config_reset(void) {
    ...
    test_call_control_reset(&s_test_config_choco_string_key_value_key_get);
...
void test_choco_string(void) {
    ...
    test_choco_string_key_value_key_get();
...
static void NO_COVERAGE test_choco_string_copy_from_c_string(void) {
    memory_system_create();
    {
        ...
        ret = choco_string_copy_from_c_string("aaa", dst);
        assert(CHOCO_STRING_NO_MEMORY == ret);
    ...
    }
    {
        ...
        ret = choco_string_copy_from_c_string("aaa", NULL);
        assert(CHOCO_STRING_INVALID_ARGUMENT == ret);
    ...
    }
    {
        ...
        ret = choco_string_copy_from_c_string(NULL, dst);
        assert(CHOCO_STRING_INVALID_ARGUMENT == ret);
    ...
    }
    {
        ...
        ret = choco_string_copy_from_c_string("aaa", (choco_string_t*)&corrupted_dst);
        assert(CHOCO_STRING_DATA_CORRUPTED == ret);
    ...
    }
    {
        ...
        ret = choco_string_copy_from_c_string("a", dst);
        assert(CHOCO_STRING_OVERFLOW == ret);
...
static void NO_COVERAGE test_choco_string_concat(void) {
    ...
    }
    {
        ...
        ret = choco_string_copy_from_c_string("bbb", dst);
        assert(CHOCO_STRING_SUCCESS == ret);
        assert(3U == dst->len);
...
// Generated by ChatGPT
static void NO_COVERAGE test_choco_string_substring_exists(void) {
    {
        // choco_string_substring_exists() 冒頭で強制的に true を返させる
        bool ret = false;
        test_call_control_bool_t config = { 0 };
        ...
        config.fail_on_call = 1U;
        config.forced_result = true;
        test_choco_string_substring_exists_config_set(&config);

        ret = choco_string_substring_exists(NULL, NULL);
        assert(true == ret);

        test_choco_string_config_reset();
    }
    {
        // choco_string_substring_exists() 冒頭で2回目だけ強制的に false を返させる
        bool ret = false;
        test_call_control_bool_t config = { 0 };
        ...
        ret = choco_string_substring_exists("abcdef", "cd");
        assert(true == ret);
    ...
    }
    {
        ...
        ret = choco_string_substring_exists(NULL, "abc");
        assert(false == ret);
    ...
    }
    {
        ...
        ret = choco_string_substring_exists("abc", NULL);
        assert(false == ret);

        test_choco_string_config_reset();
    }
    {
        // str_ == NULL && target_ == NULL -> false
        bool ret = true;
    ...
    }
    {
        ...
        ret = choco_string_substring_exists("abc", "abc");
        assert(true == ret);
    ...
    }
    {
        ...
        ret = choco_string_substring_exists("abcdef", "abc");
        assert(true == ret);
    ...
    }
    {
        ...
        ret = choco_string_substring_exists("abcdef", "def");
        assert(true == ret);
    ...
    }
    {
        ...
        ret = choco_string_substring_exists("abcabcabc", "bca");
        assert(true == ret);
    ...
    }
    {
        ...
        ret = choco_string_substring_exists("abcdef", "xyz");
        assert(false == ret);

        test_choco_string_config_reset();
    }
    {
        // target_ が str_ より長い -> false
        bool ret = true;

        test_choco_string_config_reset();

        ret = choco_string_substring_exists("abc", "abcdef");
        assert(false == ret);
    ...
    }
    {
        ...
        ret = choco_string_substring_exists("abc", "");
        assert(true == ret);

        test_choco_string_config_reset();
    }
    {
        // str_ と target_ がどちらも空文字列 -> true
        bool ret = false;

        test_choco_string_config_reset();

        ret = choco_string_substring_exists("", "");
        assert(true == ret);

        test_choco_string_config_reset();
    }
    {
        // str_ が空文字列で target_ が非空文字列 -> false
        bool ret = true;
...
// Generated by ChatGPT
static void NO_COVERAGE test_choco_string_key_value_key_get(void) {
    memory_system_create();

    {
        // choco_string_key_value_key_get() 冒頭で強制的に CHOCO_STRING_RUNTIME_ERROR を返させる
        choco_string_result_t ret = CHOCO_STRING_INVALID_ARGUMENT;
        choco_string_t* key = NULL;
        test_call_control_t config = { 0 };

        test_choco_string_config_reset();

        ret = choco_string_default_create(&key);
        assert(CHOCO_STRING_SUCCESS == ret);

        config.fail_on_call = 1U;
        config.forced_result = (int)CHOCO_STRING_RUNTIME_ERROR;
        test_choco_string_key_value_key_get_config_set(&config);

        ret = choco_string_key_value_key_get("key = value", key);
        assert(CHOCO_STRING_RUNTIME_ERROR == ret);
        assert(0U == key->len);
        assert(0 == strcmp("", choco_string_c_str(key)));

        choco_string_destroy(&key);
        test_choco_string_config_reset();
    }
    {
        ...
        ret = choco_string_key_value_key_get(NULL, key);
        assert(CHOCO_STRING_INVALID_ARGUMENT == ret);
        assert(0U == key->len);
        assert(0 == strcmp("", choco_string_c_str(key)));
    ...
    {
        // out_key_ == NULL -> CHOCO_STRING_INVALID_ARGUMENT
        choco_string_result_t ret = CHOCO_STRING_SUCCESS;

        test_choco_string_config_reset();

        ret = choco_string_key_value_key_get("key = value", NULL);
        assert(CHOCO_STRING_INVALID_ARGUMENT == ret);

        test_choco_string_config_reset();
    }
    {
        // out_key_ 内部状態破損 -> CHOCO_STRING_DATA_CORRUPTED
        choco_string_result_t ret = CHOCO_STRING_SUCCESS;
        choco_string_t key = { 0 };
    ...
    }
    {
        ...
        ret = choco_string_key_value_key_get("= value", key);
        assert(CHOCO_STRING_BAD_OPERATION == ret);
        assert(0U == key->len);
        assert(0 == strcmp("", choco_string_c_str(key)));
    ...
    {
        // '=' の前がスペースのみ -> CHOCO_STRING_BAD_OPERATION
        choco_string_result_t ret = CHOCO_STRING_SUCCESS;
        choco_string_t* key = NULL;
    ...
    }
    {
        ...
        assert(CHOCO_STRING_SUCCESS == ret);
        assert(3U == key->len);
        assert(0 == strcmp("key", choco_string_c_str(key)));
    ...
    }
    {
        ...
        ret = choco_string_key_value_key_get("   icon_width   = 32", key);
        assert(CHOCO_STRING_SUCCESS == ret);
        assert(10U == key->len);
        assert(0 == strcmp("icon_width", choco_string_c_str(key)));
    ...
    }
    {
        ...
        ret = choco_string_key_value_key_get("k ey = value", key);
        assert(CHOCO_STRING_SUCCESS == ret);
        assert(4U == key->len);
        assert(0 == strcmp("k ey", choco_string_c_str(key)));

        choco_string_destroy(&key);
        test_choco_string_config_reset();
    }
    {
        // 正常系: valueが空でもkeyを取得する
        choco_string_result_t ret = CHOCO_STRING_INVALID_ARGUMENT;
        choco_string_t* key = NULL;
        ...
        ret = choco_string_key_value_key_get("icon_width =", key);
        assert(CHOCO_STRING_SUCCESS == ret);
        assert(10U == key->len);
        assert(0 == strcmp("icon_width", choco_string_c_str(key)));
    ...
    }
    {
        ...
        ret = choco_string_key_value_key_get("icon_height =    ", key);
        assert(CHOCO_STRING_SUCCESS == ret);
        assert(11U == key->len);
        assert(0 == strcmp("icon_height", choco_string_c_str(key)));
    ...
    }
    {
        ...
        ret = choco_string_create_from_c_string("old_key", &key);
        assert(CHOCO_STRING_SUCCESS == ret);
