...
static const char* const s_rslt_str_overflow = "OVERFLOW";                  /**< 実行結果コード(オーバーフロー)文字列 */
...
geometry_system_result_t geometry_system_rslt_convert_resource(resource_result_t rslt_) {
    ...
    case RESOURCE_RUNTIME_ERROR:
        return GEOMETRY_SYSTEM_RUNTIME_ERROR;
    case RESOURCE_INVALID_ARGUMENT:
        return GEOMETRY_SYSTEM_INVALID_ARGUMENT;
    case RESOURCE_DATA_CORRUPTED:
        return GEOMETRY_SYSTEM_DATA_CORRUPTED;
    case RESOURCE_BAD_OPERATION:
        return GEOMETRY_SYSTEM_BAD_OPERATION;
    case RESOURCE_OVERFLOW:
        return GEOMETRY_SYSTEM_OVERFLOW;
    case RESOURCE_LIMIT_EXCEEDED:
        return GEOMETRY_SYSTEM_LIMIT_EXCEEDED;
    case RESOURCE_FILE_OPEN_ERROR:
        return GEOMETRY_SYSTEM_FILE_OPEN_ERROR;
    case RESOURCE_FILE_READ_ERROR:
        return GEOMETRY_SYSTEM_FILE_READ_ERROR;
    case RESOURCE_FILE_CLOSE_ERROR:
        return GEOMETRY_SYSTEM_FILE_CLOSE_ERROR;
    case RESOURCE_UNSUPPORTED_FILE:
        return GEOMETRY_SYSTEM_UNSUPPORTED_FILE;
