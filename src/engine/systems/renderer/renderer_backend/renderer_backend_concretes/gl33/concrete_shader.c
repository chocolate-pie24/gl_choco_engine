...
// static test_call_control_t s_test_config_gl33_vec4u8_uniform_set;                   /**< gl33_vec4u8_uniform_set()テスト設定 */
...
// static test_call_control_no_op_t s_test_config_mock_glUniform4fv;                   /**< mock_glUniform4fv()テスト設定 */
...
// static void test_gl33_vec4u8_uniform_set(void);
...
// static void test_mock_glUniform4fv(void);
...
//             return (renderer_backend_result_t)s_test_config_gl33_shader_create.forced_result;
//         }
//     }
// #endif
...
//     // ここはカバレッジ到達不可だけど許容する
//     if(RENDERER_BACKEND_SUCCESS != ret && NULL != tmp) {
//         assert(false);
//     }
// #endif
    return ret;
...
//             return (renderer_backend_result_t)s_test_config_gl33_shader_compile.forced_result;
//         }
//     }
// #endif
    renderer_backend_result_t ret = RENDERER_BACKEND_INVALID_ARGUMENT;
...
//             return (renderer_backend_result_t)s_test_config_gl33_shader_link.forced_result;
//         }
//     }
// #endif
    renderer_backend_result_t ret = RENDERER_BACKEND_INVALID_ARGUMENT;
...
//             return (renderer_backend_result_t)s_test_config_gl33_shader_use.forced_result;
//         }
//     }
// #endif
    renderer_backend_result_t ret = RENDERER_BACKEND_INVALID_ARGUMENT;
...
//             return (renderer_backend_result_t)s_test_config_gl33_uniform_location_get.forced_result;
//         }
//     }
// #endif
    renderer_backend_result_t ret = RENDERER_BACKEND_INVALID_ARGUMENT;
...
//             return (renderer_backend_result_t)s_test_config_gl33_mat4f_uniform_set.forced_result;
//         }
//     }
// #endif
    renderer_backend_result_t ret = RENDERER_BACKEND_INVALID_ARGUMENT;
...
//         if(s_test_config_gl33_vec4u8_uniform_set.call_count == s_test_config_gl33_vec4u8_uniform_set.fail_on_call) {
//             return (renderer_backend_result_t)s_test_config_gl33_vec4u8_uniform_set.forced_result;
//         }
//     }
// #endif
    renderer_backend_result_t ret = RENDERER_BACKEND_INVALID_ARGUMENT;
...
//             return (renderer_backend_result_t)s_test_config_gl33_shader_handle_addr_get.forced_result;
//         }
//     }
// #endif
    renderer_backend_result_t ret = RENDERER_BACKEND_INVALID_ARGUMENT;
...
//             return (renderer_backend_result_t)s_test_config_gl33_shader_resolve_target.forced_result;
//         }
//     }
// #endif
    renderer_backend_result_t ret = RENDERER_BACKEND_INVALID_ARGUMENT;
...
// #ifdef TEST_BUILD
//     s_test_config_mock_glUniform4fv.call_count++;
//     if(s_test_config_mock_glUniform4fv.fail_on_call != 0) {
//         if(s_test_config_mock_glUniform4fv.call_count == s_test_config_mock_glUniform4fv.fail_on_call) {
//             return;
//         }
//     }
// #endif
...
//     test_call_control_reset(&s_test_config_gl33_vec4u8_uniform_set);
...
//     test_call_control_no_op_reset(&s_test_config_mock_glUniform4fv);
...
//     assert(vtable1->renderer_shader_vec4u8_uniform_set == gl33_vec4u8_uniform_set);
// }

// // Generated by ChatGPT
// static void NO_COVERAGE test_gl33_shader_create(void) {
//     {
//         // gl33_shader_create() 冒頭で強制的に RENDERER_BACKEND_BAD_OPERATION を返させる
...
//         s_test_config_gl33_shader_create.forced_result = (int)RENDERER_BACKEND_BAD_OPERATION;
...
//     }
//     {
//         // メモリシステム未初期化 -> renderer_mem_allocate() 経由で RENDERER_BACKEND_BAD_OPERATION
//         renderer_backend_result_t ret = RENDERER_BACKEND_UNDEFINED_ERROR;
//         renderer_backend_shader_t* shader_handle = NULL;
...
//     }
//     {
//         // 下位 memory_system_allocate() 冒頭で未定義値を返させる -> RENDERER_BACKEND_UNDEFINED_ERROR
//         renderer_backend_result_t ret = RENDERER_BACKEND_SUCCESS;
//         memory_system_result_t ret_msys = MEMORY_SYSTEM_INVALID_ARGUMENT;
//         renderer_backend_shader_t* shader_handle = NULL;
//         test_call_control_t config = { 0 };
...
//         ret = gl33_shader_create(&shader_handle);
//         assert(RENDERER_BACKEND_UNDEFINED_ERROR == ret);
//         assert(NULL == shader_handle);
...
//     {
//         // gl33_shader_compile() 冒頭で強制的に RENDERER_BACKEND_RUNTIME_ERROR を返させる
//         renderer_backend_result_t ret = RENDERER_BACKEND_UNDEFINED_ERROR;
...
//         s_test_config_gl33_shader_compile.forced_result = (int)RENDERER_BACKEND_RUNTIME_ERROR;
...
//     }
//     {
//         // 既に vertex shader がコンパイル済み -> RENDERER_BACKEND_BAD_OPERATION
//         renderer_backend_result_t ret = RENDERER_BACKEND_UNDEFINED_ERROR;
//         renderer_backend_shader_t shader_handle = { 0 };
//         const char* shader_source = "dummy shader source";
...
//     }
//     {
//         // 既に fragment shader がコンパイル済み -> RENDERER_BACKEND_BAD_OPERATION
//         renderer_backend_result_t ret = RENDERER_BACKEND_UNDEFINED_ERROR;
//         renderer_backend_shader_t shader_handle = { 0 };
//         const char* shader_source = "dummy shader source";
...
//     }
//     {
//         // 既に program_id != 0 -> RENDERER_BACKEND_BAD_OPERATION
//         renderer_backend_result_t ret = RENDERER_BACKEND_UNDEFINED_ERROR;
//         renderer_backend_shader_t shader_handle = { 0 };
//         const char* shader_source = "dummy shader source";
...
//         s_test_config_gl33_shader_handle_addr_get.forced_result = (int)RENDERER_BACKEND_RUNTIME_ERROR;
...
//         s_test_config_gl33_shader_resolve_target.forced_result = (int)RENDERER_BACKEND_INVALID_ARGUMENT;
...
//     }
//     {
//         // shader_type_ が既定値外 -> gl33_shader_handle_addr_get() で RENDERER_BACKEND_INVALID_ARGUMENT
//         renderer_backend_result_t ret = RENDERER_BACKEND_SUCCESS;
//         renderer_backend_shader_t shader_handle = { 0 };
//         const char* shader_source = "dummy shader source";
...
//     }
//     {
//         // mock_glCreateShader() が 0 を返す -> RENDERER_BACKEND_SHADER_COMPILE_ERROR
//         renderer_backend_result_t ret = RENDERER_BACKEND_SUCCESS;
//         renderer_backend_shader_t shader_handle = { 0 };
//         const char* shader_source = "dummy shader source";
...
//     {
//         // gl33_shader_link() 冒頭で強制的に RENDERER_BACKEND_RUNTIME_ERROR を返させる
//         renderer_backend_result_t ret = RENDERER_BACKEND_UNDEFINED_ERROR;
//         renderer_backend_shader_t shader_handle = { 0 };
...
//         s_test_config_gl33_shader_link.forced_result = (int)RENDERER_BACKEND_RUNTIME_ERROR;
...
//     }
//     {
//         // program_id != 0 -> RENDERER_BACKEND_BAD_OPERATION
//         renderer_backend_result_t ret = RENDERER_BACKEND_UNDEFINED_ERROR;
//         renderer_backend_shader_t shader_handle = { 0 };
...
//     }
//     {
//         // vertex shader 未コンパイル -> RENDERER_BACKEND_BAD_OPERATION
//         renderer_backend_result_t ret = RENDERER_BACKEND_UNDEFINED_ERROR;
//         renderer_backend_shader_t shader_handle = { 0 };
...
//     }
//     {
//         // fragment shader 未コンパイル -> RENDERER_BACKEND_BAD_OPERATION
//         renderer_backend_result_t ret = RENDERER_BACKEND_UNDEFINED_ERROR;
//         renderer_backend_shader_t shader_handle = { 0 };
...
//     }
//     {
//         // shader_compile_status_get() を強制的に未コンパイル扱い -> RENDERER_BACKEND_BAD_OPERATION
//         renderer_backend_result_t ret = RENDERER_BACKEND_UNDEFINED_ERROR;
//         renderer_backend_shader_t shader_handle = { 0 };
...
//     }
//     {
//         // mock_glCreateProgram() が 0 を返す -> RENDERER_BACKEND_SHADER_LINK_ERROR
//         renderer_backend_result_t ret = RENDERER_BACKEND_UNDEFINED_ERROR;
//         renderer_backend_shader_t shader_handle = { 0 };
...
//     {
//         // gl33_shader_use() 冒頭で強制的に RENDERER_BACKEND_RUNTIME_ERROR を返させる
//         renderer_backend_result_t ret = RENDERER_BACKEND_UNDEFINED_ERROR;
//         renderer_backend_shader_t shader_handle = { 0 };
...
//         s_test_config_gl33_shader_use.forced_result = (int)RENDERER_BACKEND_RUNTIME_ERROR;
...
//     }
//     {
//         // program_id != 0 かつ vertex が未コンパイル -> RENDERER_BACKEND_DATA_CORRUPTED
//         renderer_backend_result_t ret = RENDERER_BACKEND_UNDEFINED_ERROR;
//         renderer_backend_shader_t shader_handle = { 0 };
...
//     }
//     {
//         // program_id != 0 かつ fragment が未コンパイル -> RENDERER_BACKEND_DATA_CORRUPTED
//         renderer_backend_result_t ret = RENDERER_BACKEND_UNDEFINED_ERROR;
//         renderer_backend_shader_t shader_handle = { 0 };
...
//     {
//         // gl33_uniform_location_get() 冒頭で強制的に RENDERER_BACKEND_BAD_OPERATION を返させる
//         renderer_backend_result_t ret = RENDERER_BACKEND_UNDEFINED_ERROR;
//         renderer_backend_shader_t shader_handle = { 0 };
...
//         s_test_config_gl33_uniform_location_get.forced_result = (int)RENDERER_BACKEND_BAD_OPERATION;
...
//     }
//     {
//         // mock_glGetUniformLocation() が -1 を返す -> RENDERER_BACKEND_RUNTIME_ERROR
//         renderer_backend_result_t ret = RENDERER_BACKEND_UNDEFINED_ERROR;
//         renderer_backend_shader_t shader_handle = { 0 };
//         int32_t location = -999;
...
//     }
//     {
//         // mock_glGetUniformLocation() が有効な location を返す -> RENDERER_BACKEND_SUCCESS
//         renderer_backend_result_t ret = RENDERER_BACKEND_UNDEFINED_ERROR;
//         renderer_backend_shader_t shader_handle = { 0 };
//         int32_t location = -999;
...
//     {
//         // gl33_mat4f_uniform_set() 冒頭で強制的に RENDERER_BACKEND_RUNTIME_ERROR を返させる
//         renderer_backend_result_t ret = RENDERER_BACKEND_UNDEFINED_ERROR;
//         float data[16] = { 0.0f };
...
//         s_test_config_gl33_mat4f_uniform_set.forced_result = (int)RENDERER_BACKEND_RUNTIME_ERROR;
...
// // Generated by ChatGPT
// static void NO_COVERAGE test_gl33_vec4u8_uniform_set(void) {
//     {
//         // gl33_vec4u8_uniform_set() 冒頭で強制的に RENDERER_BACKEND_RUNTIME_ERROR を返させる
//         renderer_backend_result_t ret = RENDERER_BACKEND_UNDEFINED_ERROR;
...
//         s_test_config_gl33_vec4u8_uniform_set.forced_result = (int)RENDERER_BACKEND_RUNTIME_ERROR;
...
//     {
//         // gl33_shader_handle_addr_get() 冒頭で強制的に RENDERER_BACKEND_RUNTIME_ERROR を返させる
//         renderer_backend_result_t ret = RENDERER_BACKEND_UNDEFINED_ERROR;
//         renderer_backend_shader_t shader_handle = { 0 };
...
//     }
//     {
//         // out_handle_addr_ == NULL -> RENDERER_BACKEND_INVALID_ARGUMENT
//         renderer_backend_result_t ret = RENDERER_BACKEND_UNDEFINED_ERROR;
//         renderer_backend_shader_t shader_handle = { 0 };
...
//     }
//     {
//         // 既定値外の shader_type_ -> RENDERER_BACKEND_INVALID_ARGUMENT
//         renderer_backend_result_t ret = RENDERER_BACKEND_UNDEFINED_ERROR;
//         renderer_backend_shader_t shader_handle = { 0 };
//         GLuint* out_handle_addr = NULL;
...
//     {
//         // gl33_shader_resolve_target() 冒頭で強制的に RENDERER_BACKEND_RUNTIME_ERROR を返させる
//         renderer_backend_result_t ret = RENDERER_BACKEND_UNDEFINED_ERROR;
//         GLenum gl33_type = 0U;
...
//         s_test_config_gl33_shader_resolve_target.fail_on_call = 1U;
//         s_test_config_gl33_shader_resolve_target.forced_result = (int)RENDERER_BACKEND_RUNTIME_ERROR;
...
//     }
//     {
//         // out_gl33_type_ == NULL -> RENDERER_BACKEND_INVALID_ARGUMENT
//         renderer_backend_result_t ret = RENDERER_BACKEND_UNDEFINED_ERROR;
...
// // Generated by ChatGPT
// static void NO_COVERAGE test_mock_glUniform4fv(void) {
//     // モック関数のテストは当面は不要(ほとんどが失敗注入だけのため他のテストケースで代用可能であるため)
// }
