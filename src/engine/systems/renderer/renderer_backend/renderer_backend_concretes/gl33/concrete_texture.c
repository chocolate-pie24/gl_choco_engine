...
//             return (renderer_backend_result_t)s_test_config_gl33_texture_create.forced_result;
//         }
//     }
// #endif
...
//             return (renderer_backend_result_t)s_test_config_gl33_texture_bind.forced_result;
//         }
//     }
// #endif
    renderer_backend_result_t ret = RENDERER_BACKEND_INVALID_ARGUMENT;
...
//             return (renderer_backend_result_t)s_test_config_gl33_texture_unbind.forced_result;
//         }
//     }
// #endif
    renderer_backend_result_t ret = RENDERER_BACKEND_INVALID_ARGUMENT;
...
//             return (renderer_backend_result_t)s_test_config_gl33_texture_pixel_upload.forced_result;
//         }
//     }
// #endif
    renderer_backend_result_t ret = RENDERER_BACKEND_INVALID_ARGUMENT;
...
//     {
//         // gl33_texture_create() 冒頭で強制的に RENDERER_BACKEND_BAD_OPERATION を返させる
...
//         s_test_config_gl33_texture_create.forced_result = (int)RENDERER_BACKEND_BAD_OPERATION;
...
//     }
//     {
//         // texture_handle_ == NULL -> RENDERER_BACKEND_INVALID_ARGUMENT
//         renderer_backend_result_t ret = RENDERER_BACKEND_UNDEFINED_ERROR;
...
//     }
//     {
//         // resolve_min_filter_config() が false -> RENDERER_BACKEND_INVALID_ARGUMENT
//         renderer_backend_result_t ret = RENDERER_BACKEND_UNDEFINED_ERROR;
//         renderer_backend_texture_t* texture = NULL;
...
//     }
//     {
//         // resolve_mag_filter_config() が false -> RENDERER_BACKEND_INVALID_ARGUMENT
//         renderer_backend_result_t ret = RENDERER_BACKEND_UNDEFINED_ERROR;
//         renderer_backend_texture_t* texture = NULL;
...
//     }
//     {
//         // s軸の resolve_wrap_config() が false -> RENDERER_BACKEND_INVALID_ARGUMENT
//         renderer_backend_result_t ret = RENDERER_BACKEND_UNDEFINED_ERROR;
//         renderer_backend_texture_t* texture = NULL;
...
//     }
//     {
//         // t軸の resolve_wrap_config() が false -> RENDERER_BACKEND_INVALID_ARGUMENT
//         renderer_backend_result_t ret = RENDERER_BACKEND_UNDEFINED_ERROR;
//         renderer_backend_texture_t* texture = NULL;
...
//     }
//     {
//         // unit_num_ < 0 -> RENDERER_BACKEND_INVALID_ARGUMENT
//         renderer_backend_result_t ret = RENDERER_BACKEND_UNDEFINED_ERROR;
//         renderer_backend_texture_t* texture = NULL;
...
//     {
//         // gl33_texture_unbind() 冒頭で強制的に RENDERER_BACKEND_RUNTIME_ERROR を返させる
//         renderer_backend_result_t ret = RENDERER_BACKEND_UNDEFINED_ERROR;
...
//         s_test_config_gl33_texture_unbind.forced_result = (int)RENDERER_BACKEND_RUNTIME_ERROR;
...
//     }
//     {
//         // texture_handle_->handle == 0 -> RENDERER_BACKEND_DATA_CORRUPTED
//         renderer_backend_result_t ret = RENDERER_BACKEND_UNDEFINED_ERROR;
//         renderer_backend_texture_t texture = { 0 };
...
//     }
//     {
//         // texture_handle_->unit_number < 0 -> RENDERER_BACKEND_DATA_CORRUPTED
//         renderer_backend_result_t ret = RENDERER_BACKEND_UNDEFINED_ERROR;
//         renderer_backend_texture_t texture = { 0 };
