...
static renderer_backend_result_t gl33_vbo_create(renderer_backend_vbo_t** vertex_buffer_);
static void gl33_vbo_destroy(renderer_backend_vbo_t** vertex_buffer_);
static renderer_backend_result_t gl33_vbo_bind(const renderer_backend_vbo_t* vertex_buffer_);
...
//             return (renderer_backend_result_t)s_test_config_gl33_vbo_create.forced_result;
//         }
//     }
// #endif
    ...
    IF_ARG_NULL_GOTO_CLEANUP(vertex_buffer_, ret, RENDERER_BACKEND_INVALID_ARGUMENT, renderer_backend_rslt_to_str(RENDERER_BACKEND_INVALID_ARGUMENT), "gl33_vbo_create", "vertex_buffer_")
    IF_ARG_NOT_NULL_GOTO_CLEANUP(*vertex_buffer_, ret, RENDERER_BACKEND_INVALID_ARGUMENT, renderer_backend_rslt_to_str(RENDERER_BACKEND_INVALID_ARGUMENT), "gl33_vbo_create", "vertex_buffer_")
...
// #endif
    ...
    memory_system_free(*vertex_buffer_, sizeof(renderer_backend_vbo_t), MEMORY_TAG_RENDERER);
...
//             return (renderer_backend_result_t)s_test_config_gl33_vbo_bind.forced_result;
//         }
//     }
// #endif
    renderer_backend_result_t ret = RENDERER_BACKEND_INVALID_ARGUMENT;

    IF_ARG_NULL_GOTO_CLEANUP(vertex_buffer_, ret, RENDERER_BACKEND_INVALID_ARGUMENT, renderer_backend_rslt_to_str(RENDERER_BACKEND_INVALID_ARGUMENT), "gl33_vbo_bind", "vertex_buffer_")
    IF_ARG_FALSE_GOTO_CLEANUP(0 != vertex_buffer_->vbo_handle, ret, RENDERER_BACKEND_BAD_OPERATION, renderer_backend_rslt_to_str(RENDERER_BACKEND_BAD_OPERATION), "gl33_vbo_bind", "vertex_buffer_->vbo_handle")
...
//             return (renderer_backend_result_t)s_test_config_gl33_vbo_unbind.forced_result;
//         }
//     }
// #endif
    renderer_backend_result_t ret = RENDERER_BACKEND_INVALID_ARGUMENT;
...
//             return (renderer_backend_result_t)s_test_config_gl33_vbo_vertex_load.forced_result;
//         }
//     }
// #endif
    renderer_backend_result_t ret = RENDERER_BACKEND_INVALID_ARGUMENT;
...
//             return (renderer_backend_result_t)s_test_config_gl33_vbo_vertex_subload.forced_result;
//         }
//     }
// #endif
    renderer_backend_result_t ret = RENDERER_BACKEND_INVALID_ARGUMENT;
...
//     {
//         // gl33_vbo_create() 冒頭で強制的に RENDERER_BACKEND_BAD_OPERATION を返させる
...
//         s_test_config_gl33_vbo_create.forced_result = (int)RENDERER_BACKEND_BAD_OPERATION;
...
//         s_test_config_gl33_vbo_unbind.forced_result = (int)RENDERER_BACKEND_RUNTIME_ERROR;
...
//     {
//         // gl33_vbo_bind() 冒頭で強制的に RENDERER_BACKEND_RUNTIME_ERROR を返させる
//         renderer_backend_result_t ret = RENDERER_BACKEND_UNDEFINED_ERROR;
...
//         s_test_config_gl33_vbo_bind.forced_result = (int)RENDERER_BACKEND_RUNTIME_ERROR;
...
//     }
//     {
//         // vbo_handle == 0 -> RENDERER_BACKEND_BAD_OPERATION
//         renderer_backend_result_t ret = RENDERER_BACKEND_UNDEFINED_ERROR;
//         renderer_backend_vbo_t vbo = { 0 };
...
//     {
//         // gl33_vbo_unbind() 冒頭で強制的に RENDERER_BACKEND_RUNTIME_ERROR を返させる
//         renderer_backend_result_t ret = RENDERER_BACKEND_UNDEFINED_ERROR;
...
//     {
//         // gl33_vbo_vertex_load() 冒頭で強制的に RENDERER_BACKEND_RUNTIME_ERROR を返させる
//         renderer_backend_result_t ret = RENDERER_BACKEND_UNDEFINED_ERROR;
...
//         s_test_config_gl33_vbo_vertex_load.forced_result = (int)RENDERER_BACKEND_RUNTIME_ERROR;
...
//     }
//     {
//         // load_size_ == 0 -> RENDERER_BACKEND_INVALID_ARGUMENT
//         renderer_backend_result_t ret = RENDERER_BACKEND_UNDEFINED_ERROR;
//         float vertex_data[6] = { 0.0f };
...
//     }
//     {
//         // 未対応 usage_ -> RENDERER_BACKEND_RUNTIME_ERROR
//         renderer_backend_result_t ret = RENDERER_BACKEND_UNDEFINED_ERROR;
//         float vertex_data[6] = { 0.0f };
...
//     {
//         // gl33_vbo_vertex_subload() 冒頭で強制的に RENDERER_BACKEND_RUNTIME_ERROR を返させる
//         renderer_backend_result_t ret = RENDERER_BACKEND_UNDEFINED_ERROR;
//         float vertex_data[6] = { 0.0f };
...
//         s_test_config_gl33_vbo_vertex_subload.forced_result = (int)RENDERER_BACKEND_RUNTIME_ERROR;
