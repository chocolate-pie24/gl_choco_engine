...
bool lit_mesh_geometry_registry_find(const char* name_, const lit_mesh_geometry_registry_t* registry_) {
    size_t tmp_id = 0;
...
resource_registry_result_t lit_mesh_geometry_registry_register(const lit_mesh_geometry_t* geometry_, size_t vertex_offset_, lit_mesh_geometry_registry_t* registry_, int16_t* out_geometry_id_) {
    resource_registry_result_t ret = RESOURCE_REGISTRY_INVALID_ARGUMENT;
    resource_result_t ret_resource = RESOURCE_INVALID_ARGUMENT;
...
resource_registry_result_t lit_mesh_geometry_registry_unregister(int16_t geometry_id_, lit_mesh_geometry_registry_t* registry_) {
    resource_registry_result_t ret = RESOURCE_REGISTRY_INVALID_ARGUMENT;
    ...
    IF_ARG_FALSE_GOTO_CLEANUP(geometry_id_is_valid(geometry_id_, registry_), ret, RESOURCE_REGISTRY_INVALID_ARGUMENT, resource_registry_rslt_to_str(RESOURCE_REGISTRY_INVALID_ARGUMENT), "lit_mesh_geometry_registry_unregister", "geometry_id_")
