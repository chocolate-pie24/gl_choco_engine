...
typedef enum {
    SUBSYSTEM_ALLOCATOR_MEMORY_TAG_PLATFORM_SYSTEM = 0,
    SUBSYSTEM_ALLOCATOR_MEMORY_TAG_RENDERER_SYSTEM,
    SUBSYSTEM_ALLOCATOR_MEMORY_TAG_EVENT_SYSTEM,
    SUBSYSTEM_ALLOCATOR_MEMORY_TAG_FLIGHT_CAMERA_SYSTEM,
