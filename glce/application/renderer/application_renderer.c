...
static application_result_t app_line_mesh_shader_create(const line_mesh_shader_config_t* line_mesh_shader_config_, renderer_backend_context_t* renderer_backend_context_, const char* executable_directory_, const char* shader_dir_, line_mesh_shader_t** out_line_mesh_shader_);
...
application_result_t application_renderer_initialize(const renderer_config_t* renderer_config_, target_graphics_api_t target_api_, linear_alloc_t* allocator_, const char* executable_directory_, const char* shader_dir_, application_renderer_t** out_application_renderer_) {
    ...
    ret = app_line_mesh_shader_create(&renderer_config_->line_mesh_shader_config, tmp_renderer_backend_context, executable_directory_, shader_dir_, &tmp_line_mesh_shader);
    if(APPLICATION_SUCCESS != ret) {
        ERROR_MESSAGE("application_renderer_initialize(%s) - app_line_mesh_shader_create failed.", app_rslt_to_str(ret));
        goto cleanup;
    }
    ...
    tmp_application_renderer->line_mesh_shader = tmp_line_mesh_shader;
...
void application_renderer_deinitialize(application_renderer_t* application_renderer_) {
    ...
    line_mesh_shader_destroy(&application_renderer_->line_mesh_shader);
...
application_result_t application_renderer_update(application_renderer_t* application_renderer_, bool view_dirty_, bool projection_dirty_, const mat4x4f_t* view_matrix_, const mat4x4f_t* projection_matrix_, bool should_transpose_view_matrix_, bool should_transpose_projection_matrix_) {
    ...
    if(projection_dirty_) {
        ...
        ret_shader = line_mesh_shader_use(application_renderer_->line_mesh_shader);
        if(SHADER_SUCCESS != ret_shader) {
            ret = app_rslt_convert_shader(ret_shader);
            ERROR_MESSAGE("application_renderer_update(%s) - line_mesh_shader_use failed.", app_rslt_to_str(ret));
            goto cleanup;
        }

        ret_shader = line_mesh_shader_projection_matrix_set(application_renderer_->line_mesh_shader, projection_matrix_, should_transpose_projection_matrix_);
        if(SHADER_SUCCESS != ret_shader) {
            ret = app_rslt_convert_shader(ret_shader);
            ERROR_MESSAGE("application_renderer_update(%s) - line_mesh_shader_projection_matrix_set failed.", app_rslt_to_str(ret));
            goto cleanup;
        }
    ...
    if(view_dirty_) {
        ...
        ret_shader = line_mesh_shader_view_matrix_set(application_renderer_->line_mesh_shader, view_matrix_, should_transpose_view_matrix_);
        if(SHADER_SUCCESS != ret_shader) {
            ret = app_rslt_convert_shader(ret_shader);
            ERROR_MESSAGE("application_renderer_update(%s) - line_mesh_shader_view_matrix_set failed.", app_rslt_to_str(ret));
            goto cleanup;
        }
...
application_result_t application_renderer_vao_bind(application_renderer_t* application_renderer_, application_renderer_shader_type_t shader_type_) {
    ...
    switch(shader_type_) {
    case APPLICATION_RENDERER_SHADER_TYPE_LINE_MESH:
        ret_shader = line_mesh_shader_vao_bind(application_renderer_->line_mesh_shader);
        break;
    case APPLICATION_RENDERER_SHADER_TYPE_LIT_MESH:
...
application_result_t application_renderer_model_matrix_set(application_renderer_t* application_renderer_, application_renderer_shader_type_t shader_type_, const mat4x4f_t* model_matrix_, bool should_transpose_) {
    ...
    switch(shader_type_) {
    case APPLICATION_RENDERER_SHADER_TYPE_LINE_MESH:
        ret_shader = line_mesh_shader_model_matrix_set(application_renderer_->line_mesh_shader, model_matrix_, should_transpose_);
        break;
    case APPLICATION_RENDERER_SHADER_TYPE_LIT_MESH:
...
application_result_t application_renderer_view_matrix_set(application_renderer_t* application_renderer_, application_renderer_shader_type_t shader_type_, const mat4x4f_t* view_matrix_, bool should_transpose_) {
    ...
    switch(shader_type_) {
    case APPLICATION_RENDERER_SHADER_TYPE_LINE_MESH:
        ret_shader = line_mesh_shader_view_matrix_set(application_renderer_->line_mesh_shader, view_matrix_, should_transpose_);
        break;
    case APPLICATION_RENDERER_SHADER_TYPE_LIT_MESH:
...
application_result_t application_renderer_projection_matrix_set(application_renderer_t* application_renderer_, application_renderer_shader_type_t shader_type_, const mat4x4f_t* projection_matrix_, bool should_transpose_) {
    ...
    switch(shader_type_) {
    case APPLICATION_RENDERER_SHADER_TYPE_LINE_MESH:
        ret_shader = line_mesh_shader_projection_matrix_set(application_renderer_->line_mesh_shader, projection_matrix_, should_transpose_);
        break;
    case APPLICATION_RENDERER_SHADER_TYPE_LIT_MESH:
...
application_result_t application_renderer_line_mesh_color_set(application_renderer_t* application_renderer_, const uint8_t color_[4]) {
    ...
    IF_ARG_NULL_GOTO_CLEANUP(application_renderer_, ret, APPLICATION_INVALID_ARGUMENT, app_rslt_to_str(APPLICATION_INVALID_ARGUMENT), "application_renderer_line_mesh_color_set", "application_renderer_")
    IF_ARG_NULL_GOTO_CLEANUP(color_, ret, APPLICATION_INVALID_ARGUMENT, app_rslt_to_str(APPLICATION_INVALID_ARGUMENT), "application_renderer_line_mesh_color_set", "color_")
#if defined(DEBUG_BUILD) || defined(TEST_BUILD)
    if(!is_valid_shallow(application_renderer_)) {
        ret = APPLICATION_DATA_CORRUPTED;
        ERROR_MESSAGE("application_renderer_line_mesh_color_set(%s) - Precondition validation failed for 'application_renderer_'.", app_rslt_to_str(ret));
        goto cleanup;
    }
#endif

    ret_shader = line_mesh_shader_color_set(application_renderer_->line_mesh_shader, color_);
    if(SHADER_SUCCESS != ret_shader) {
        ret = app_rslt_convert_shader(ret_shader);
        ERROR_MESSAGE("application_renderer_line_mesh_color_set(%s) - line_mesh_shader_color_set failed.", app_rslt_to_str(ret));
        goto cleanup;
    }
...
static application_result_t app_line_mesh_shader_create(const line_mesh_shader_config_t* line_mesh_shader_config_, renderer_backend_context_t* renderer_backend_context_, const char* executable_directory_, const char* shader_dir_, line_mesh_shader_t** out_line_mesh_shader_) {
    ...
    IF_ARG_NULL_GOTO_CLEANUP(line_mesh_shader_config_, ret, APPLICATION_INVALID_ARGUMENT, app_rslt_to_str(APPLICATION_INVALID_ARGUMENT), "app_line_mesh_shader_create", "line_mesh_shader_config_")
    IF_ARG_NULL_GOTO_CLEANUP(renderer_backend_context_, ret, APPLICATION_INVALID_ARGUMENT, app_rslt_to_str(APPLICATION_INVALID_ARGUMENT), "app_line_mesh_shader_create", "renderer_backend_context_")
    IF_ARG_NULL_GOTO_CLEANUP(executable_directory_, ret, APPLICATION_INVALID_ARGUMENT, app_rslt_to_str(APPLICATION_INVALID_ARGUMENT), "app_line_mesh_shader_create", "executable_directory_")
    IF_ARG_NULL_GOTO_CLEANUP(shader_dir_, ret, APPLICATION_INVALID_ARGUMENT, app_rslt_to_str(APPLICATION_INVALID_ARGUMENT), "app_line_mesh_shader_create", "shader_dir_")
    IF_ARG_NULL_GOTO_CLEANUP(out_line_mesh_shader_, ret, APPLICATION_INVALID_ARGUMENT, app_rslt_to_str(APPLICATION_INVALID_ARGUMENT), "app_line_mesh_shader_create", "out_line_mesh_shader_")
    IF_ARG_NOT_NULL_GOTO_CLEANUP(*out_line_mesh_shader_, ret, APPLICATION_BAD_OPERATION, app_rslt_to_str(APPLICATION_BAD_OPERATION), "app_line_mesh_shader_create", "*out_line_mesh_shader_")
    ...
    if(FS_PATH_SUCCESS != ret_fs_path) {
        ...
        ERROR_MESSAGE("app_line_mesh_shader_create(%s) - fs_path_create failed.", app_rslt_to_str(ret));
        goto cleanup;
    }
    ...
    if(SHADER_LINK_ERROR == ret_shader || SHADER_COMPILE_ERROR == ret_shader) {
        ...
        ERROR_MESSAGE("app_line_mesh_shader_create(%s) - line_mesh_shader_create failed.", app_rslt_to_str(ret));
        goto cleanup;
    } else if(SHADER_SUCCESS != ret_shader) {
        ret = app_rslt_convert_shader(ret_shader);
        ERROR_MESSAGE("app_line_mesh_shader_create(%s) - Failed to create line mesh shader.", app_rslt_to_str(ret));
        goto cleanup;
    }
...
static bool is_valid_shallow(const application_renderer_t* application_renderer_) {
    ...
    if(NULL == application_renderer_->line_mesh_shader) {
        return false;
    }
