...
application_result_t application_flight_camera_create(size_t max_flight_camera_count_, subsystem_allocator_t* allocator_, int framebuffer_width_, int framebuffer_height_, application_flight_camera_t** out_flight_camera_) {
    ...
    if(0 >= framebuffer_width_ || 0 >= framebuffer_height_) {
        ret = APPLICATION_INVALID_ARGUMENT;
        ERROR_MESSAGE("application_flight_camera_create(%s) - Provided framebuffer_width_ or framebuffer_height_ is not valid.", application_result_to_str(ret));
        goto cleanup;
    }
    ...
    if(CAMERA_REGISTRY_SUCCESS != ret_camera_registry) {
        ret = application_result_convert_camera_registry(ret_camera_registry);
        ERROR_MESSAGE("application_flight_camera_create(%s) - flight_camera_registry_create failed.", application_result_to_str(ret));
        goto cleanup;
    }
    ...
    if(CAMERA_SUCCESS != ret_camera) {
        ...
        ERROR_MESSAGE("application_flight_camera_create(%s) - flight_camera_create failed.", application_result_to_str(ret));
        goto cleanup;
    }
    ...
    if(CAMERA_REGISTRY_SUCCESS != ret_camera_registry) {
        ret = application_result_convert_camera_registry(ret_camera_registry);
        ERROR_MESSAGE("application_flight_camera_create(%s) - flight_camera_registry_register failed.", application_result_to_str(ret));
        goto cleanup;
    }
    ...
    if(NULL == tmp_application_flight_camera->active_camera) {
        ...
        ERROR_MESSAGE("application_flight_camera_create(%s) - flight_camera_registry_flight_camera_get failed.", application_result_to_str(ret));
        goto cleanup;
    }
    ...
    if(!application_flight_camera_is_valid(tmp_application_flight_camera)) {
        ret = APPLICATION_DATA_CORRUPTED;
        ERROR_MESSAGE("application_flight_camera_create(%s) - Postcondition validation failed for 'tmp_application_flight_camera'.", application_result_to_str(ret));
        goto cleanup;
    }
#endif
