...
shader_result_t lit_mesh_shader_vbo_initialize(renderer_backend_context_t* backend_context_, lit_mesh_shader_t* lit_mesh_shader_, const renderer_config_t* config_) {
    shader_result_t ret = SHADER_INVALID_ARGUMENT;
    ...
    vbo_config.buffer_usage = config_->lit_mesh_shader_buffer_usage;
    vbo_config.max_allocation_count = config_->lit_mesh_shader_max_allocation_count;
    vbo_config.vbo_size = config_->lit_mesh_shader_vbo_size;
