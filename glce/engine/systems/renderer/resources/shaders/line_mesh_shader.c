...
shader_result_t line_mesh_shader_create(renderer_backend_context_t* backend_context_, const char* vertex_shader_fullpath_, const char* fragment_shader_fullpath_, const line_mesh_shader_config_t* config_, line_mesh_shader_t** out_line_mesh_shader_) {
    ...
    IF_ARG_NULL_GOTO_CLEANUP(backend_context_, ret, SHADER_INVALID_ARGUMENT, shader_rslt_to_str(SHADER_INVALID_ARGUMENT), "line_mesh_shader_create", "backend_context_")
    ...
    IF_ARG_NOT_NULL_GOTO_CLEANUP(*out_line_mesh_shader_, ret, SHADER_BAD_OPERATION, shader_rslt_to_str(SHADER_BAD_OPERATION), "line_mesh_shader_create", "*out_line_mesh_shader_")
    IF_ARG_NULL_GOTO_CLEANUP(vertex_shader_fullpath_, ret, SHADER_INVALID_ARGUMENT, shader_rslt_to_str(SHADER_INVALID_ARGUMENT), "line_mesh_shader_create", "vertex_shader_fullpath_")
    IF_ARG_NULL_GOTO_CLEANUP(fragment_shader_fullpath_, ret, SHADER_INVALID_ARGUMENT, shader_rslt_to_str(SHADER_INVALID_ARGUMENT), "line_mesh_shader_create", "fragment_shader_fullpath_")
    IF_ARG_NULL_GOTO_CLEANUP(config_, ret, SHADER_INVALID_ARGUMENT, shader_rslt_to_str(SHADER_INVALID_ARGUMENT), "line_mesh_shader_create", "config_")
    if('\0' == vertex_shader_fullpath_[0]) {
        ret = SHADER_INVALID_ARGUMENT;
        ERROR_MESSAGE("line_mesh_shader_create(%s) - Provided vertex_shader_fullpath_ is not valid.", shader_rslt_to_str(ret));
        goto cleanup;
    }
    if('\0' == fragment_shader_fullpath_[0]) {
        ret = SHADER_INVALID_ARGUMENT;
        ERROR_MESSAGE("line_mesh_shader_create(%s) - Provided fragment_shader_fullpath_ is not valid.", shader_rslt_to_str(ret));
        goto cleanup;
    }
    if(!line_mesh_shader_config_is_valid(config_)) {
        ret = SHADER_INVALID_ARGUMENT;
        ERROR_MESSAGE("line_mesh_shader_create(%s) - Provided config_ is not valid.", shader_rslt_to_str(ret));
        goto cleanup;
    }
    ...
    if(SHADER_SUCCESS != ret) {
        ERROR_MESSAGE("line_mesh_shader_create(%s) - program_initialize failed.", shader_rslt_to_str(ret));
        goto cleanup;
    }

    ret = vbo_initialize(tmp_line_mesh_shader, config_);
    if(SHADER_SUCCESS != ret) {
        ERROR_MESSAGE("line_mesh_shader_create(%s) - vbo_initialize failed.", shader_rslt_to_str(ret));
        goto cleanup;
    }

    ret = vao_initialize(tmp_line_mesh_shader);
    if(SHADER_SUCCESS != ret) {
        ERROR_MESSAGE("line_mesh_shader_create(%s) - vao_initialize failed.", shader_rslt_to_str(ret));
        goto cleanup;
    }
...
shader_result_t line_mesh_shader_vbo_write(line_mesh_shader_t* line_mesh_shader_, size_t vertex_count_, const line_vertex_t* vertices_, vbo_range_t* out_buffer_range_) {
    ...
    IF_ARG_NULL_GOTO_CLEANUP(line_mesh_shader_, ret, SHADER_INVALID_ARGUMENT, shader_rslt_to_str(SHADER_INVALID_ARGUMENT), "line_mesh_shader_vbo_write", "line_mesh_shader_")
...
static shader_result_t program_initialize(line_mesh_shader_t* line_mesh_shader_, const char* vertex_shader_fullpath_, const char* fragment_shader_fullpath_) {
    ...
    IF_ARG_NULL_GOTO_CLEANUP(line_mesh_shader_, ret, SHADER_INVALID_ARGUMENT, shader_rslt_to_str(SHADER_INVALID_ARGUMENT), "program_initialize", "line_mesh_shader_")
    ...
    if(RENDERER_BACKEND_SUCCESS != ret_renderer_backend) {
        ret = shader_rslt_convert_renderer_backend(ret_renderer_backend);
        ERROR_MESSAGE("program_initialize(%s) - Failed to get color location.", shader_rslt_to_str(ret));
        goto cleanup;
    }
...
static shader_result_t vbo_initialize(line_mesh_shader_t* line_mesh_shader_, const line_mesh_shader_config_t* config_) {
    ...
    IF_ARG_NULL_GOTO_CLEANUP(line_mesh_shader_, ret, SHADER_INVALID_ARGUMENT, shader_rslt_to_str(SHADER_INVALID_ARGUMENT), "vbo_initialize", "line_mesh_shader_")
    ...
    ret_buff_mgr = vbo_manager_create(line_mesh_shader_->backend_context, &vbo_config, &tmp_vbo_manager);
    if(BUFFER_MANAGER_SUCCESS != ret_buff_mgr) {
        ret = shader_rslt_convert_buffer_manager(ret_buff_mgr);
...
static shader_result_t vao_initialize(line_mesh_shader_t* line_mesh_shader_) {
    ...
    IF_ARG_NULL_GOTO_CLEANUP(line_mesh_shader_, ret, SHADER_INVALID_ARGUMENT, shader_rslt_to_str(SHADER_INVALID_ARGUMENT), "vao_initialize", "line_mesh_shader_")

    ret_renderer_backend = renderer_backend_vao_create(line_mesh_shader_->backend_context, &line_mesh_shader_->vao);
    if(RENDERER_BACKEND_SUCCESS != ret_renderer_backend) {
        ret = shader_rslt_convert_renderer_backend(ret_renderer_backend);
        ERROR_MESSAGE("vao_initialize(%s) - Failed to create line vao.", shader_rslt_to_str(ret));
        goto cleanup;
    }
    vao_created = true;
    ...
    if(RENDERER_BACKEND_SUCCESS != ret_renderer_backend) {
        ret = shader_rslt_convert_renderer_backend(ret_renderer_backend);
        ERROR_MESSAGE("vao_initialize(%s) - Failed to set vertex array attribute.", shader_rslt_to_str(ret));
        goto cleanup;
    }
