...
resource_registry_result_t lit_mesh_geometry_registry_create(size_t max_geometry_count_, linear_alloc_t* allocator_, lit_mesh_geometry_registry_t** out_registry_) {
    ...
    IF_ARG_FALSE_GOTO_CLEANUP(0 != max_geometry_count_, ret, RESOURCE_REGISTRY_INVALID_ARGUMENT, resource_registry_rslt_to_str(RESOURCE_REGISTRY_INVALID_ARGUMENT), "lit_mesh_geometry_registry_create", "max_geometry_count_")
    IF_ARG_FALSE_GOTO_CLEANUP(UINT16_MAX >= max_geometry_count_, ret, RESOURCE_REGISTRY_INVALID_ARGUMENT, resource_registry_rslt_to_str(RESOURCE_REGISTRY_INVALID_ARGUMENT), "lit_mesh_geometry_registry_create", "max_geometry_count_")
    IF_ARG_NULL_GOTO_CLEANUP(allocator_, ret, RESOURCE_REGISTRY_INVALID_ARGUMENT, resource_registry_rslt_to_str(RESOURCE_REGISTRY_INVALID_ARGUMENT), "lit_mesh_geometry_registry_create", "allocator_")
    IF_ARG_NULL_GOTO_CLEANUP(out_registry_, ret, RESOURCE_REGISTRY_INVALID_ARGUMENT, resource_registry_rslt_to_str(RESOURCE_REGISTRY_INVALID_ARGUMENT), "lit_mesh_geometry_registry_create", "out_registry_")
    IF_ARG_NOT_NULL_GOTO_CLEANUP(*out_registry_, ret, RESOURCE_REGISTRY_INVALID_ARGUMENT, resource_registry_rslt_to_str(RESOURCE_REGISTRY_INVALID_ARGUMENT), "lit_mesh_geometry_registry_create", "*out_registry_")
    ...
    if(LINEAR_ALLOC_SUCCESS != ret_linear_alloc) {
        ...
        ERROR_MESSAGE("lit_mesh_geometry_registry_create(%s) - Failed to allocate registry instance. target=lit_mesh_geometry_registry_t, bytes=%zu, align=%zu, max_geometry_count=%zu", resource_registry_rslt_to_str(ret), sizeof(lit_mesh_geometry_registry_t), alignof(lit_mesh_geometry_registry_t), max_geometry_count_);
        goto cleanup;
    }
    ...
    if((SIZE_MAX / max_geometry_count_) < sizeof(registry_entry_t)) {
        ...
        ERROR_MESSAGE("lit_mesh_geometry_registry_create(%s) - overflow.", resource_registry_rslt_to_str(ret));
        goto cleanup;
    }
    ...
    if(LINEAR_ALLOC_SUCCESS != ret_linear_alloc) {
        ret = resource_registry_rslt_convert_linear_alloc(ret_linear_alloc);
        ERROR_MESSAGE("lit_mesh_geometry_registry_create(%s) - allocation failed.", resource_registry_rslt_to_str(ret));
        goto cleanup;
    }
...
bool lit_mesh_geometry_registry_exists(const lit_mesh_geometry_registry_t* registry_, const char* name_) {
    ...
    if(!lit_mesh_geometry_registry_is_valid(registry_)) {
        ERROR_MESSAGE("lit_mesh_geometry_registry_exists(%s) - lit_mesh_geometry_registry_t internal state is corrupted.", resource_registry_rslt_to_str(RESOURCE_REGISTRY_DATA_CORRUPTED));
        return false;
    }
    if('\0' == name_[0]) {
        ERROR_MESSAGE("lit_mesh_geometry_registry_exists(%s) - provided resource name is not valid.", resource_registry_rslt_to_str(RESOURCE_REGISTRY_INVALID_ARGUMENT));
        return false;
    }
