 ...
 *
 */
#ifndef GLCE_ENGINE_SYSTEMS_PLATFORM_SYSTEM_PLATFORM_CONCRETES_GLFW_PLATFORM_GLFW_H
#define GLCE_ENGINE_SYSTEMS_PLATFORM_SYSTEM_PLATFORM_CONCRETES_GLFW_PLATFORM_GLFW_H
#ifdef __cplusplus
extern "C" {
#endif
 ...
 *
 * @note vtableの詳細は @ref platform_backend_vtable_t を参照
 *
 * @return const platform_backend_vtable_t* 仮想関数テーブル
 */
