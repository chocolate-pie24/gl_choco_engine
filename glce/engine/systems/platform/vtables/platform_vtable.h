...
typedef platform_result_t (*pfn_platform_backend_update)(platform_backend_t* platform_backend_, const platform_event_view_t** out_event_view);
...
typedef struct platform_vtable {
    pfn_platform_backend_initialize     platform_backend_initialize;
