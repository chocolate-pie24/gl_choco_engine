...
// texture_system_result_t texture_manager_register(const char* texture_name_, texture_manager_t* texture_manager_, int16_t* out_texture_id_);
...
// texture_system_result_t texture_manager_texture_get(int16_t texture_id_, const texture_manager_t* texture_manager_, texture_t** out_texture_);
